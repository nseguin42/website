/* PrismJS 1.29.0
https://prismjs.com/download.html#themes=prism-okaidia&languages=markup+css+clike+javascript+csharp+csv+java+latex+python+rust&plugins=line-highlight+line-numbers+autolinker+custom-class+show-language+highlight-keywords+autoloader+unescaped-markup+toolbar+match-braces+diff-highlight+treeview */
...
(function () {
  ...
  Prism.plugins.lineHighlight = {
    ...
    highlightLines: function highlightLines(pre, lines, classes) {
       ...
       */
      var codePreOffset =
        !codeElement || parentElement == codeElement ? 0 : getContentBoxTopOffset(pre, codeElement);
...
(function () {
  ...
  Prism.plugins.toolbar.registerButton('show-language', function (env) {
    ...
    var language =
      pre.getAttribute('data-language') || Languages[env.language] || guessTitle(env.language);
