defmodule NsWeb.CoreComponents do
  ...
  def modal(assigns) do
    ...
    >
      <div id={"#{@id}-bg"} class="fixed inset-0 bg-slate-50/90 transition-opacity" aria-hidden="true" />
      <div
        ...
        <div class="flex min-h-full items-center justify-center">
          <div class="w-full max-w-3xl p-4 sm:p-6 lg:py-8">
            <.focus_wrap
              ...
              class="hidden relative rounded-2xl bg-white p-14 shadow-lg shadow-slate-700/10 ring-1 ring-slate-700/10 transition"
            >
              ...
              <div id={"#{@id}-content"}>
                <header :if={@title != []}>
                  <h1 id={"#{@id}-title"} class="text-lg font-semibold leading-8 text-slate-800">
                    <%= render_slot(@title) %>
                  </h1>
                  <p
                    :if={@subtitle != []}
  ...
  def flash(assigns) do
    ...
    <div
      ...
      role="alert"
      class={[
        "fixed hidden top-2 right-2 w-80 sm:w-96 z-50 rounded-lg p-3 shadow-md shadow-slate-900/5 ring-1",
  ...
  def input(%{type: "textarea"} = assigns) do
    ...
    <div phx-feedback-for={@name}>
      ...
      <textarea
        ...
        name={@name}
        class={[
          "mt-2 block min-h-[6rem] w-full rounded-lg border-slate-300 py-[7px] px-[11px]",
          "text-slate-900 focus:border-slate-400 focus:outline-none focus:ring-4 focus:ring-slate-800/5 sm:text-sm sm:leading-6",
          "phx-no-feedback:border-slate-300 phx-no-feedback:focus:border-slate-400 phx-no-feedback:focus:ring-slate-800/5",
          "border-slate-300 focus:border-slate-400 focus:ring-slate-800/5",
  ...
  def input(assigns) do
    ...
    <div phx-feedback-for={@name}>
      ...
      <input
        ...
        class={[
          "mt-2 block w-full rounded-lg border-slate-300 py-[7px] px-[11px]",
  ...
  def table(assigns) do
    ...
    <div class="overflow-y-auto px-4 sm:overflow-visible sm:px-0">
      <table class="mt-11 w-[40rem] sm:w-full">
        <thead class="text-left text-[0.8125rem] leading-6 text-slate-500">
          <tr>
    ...
    <div class="mt-14">
      <dl class="-my-4 divide-y divide-slate-100">
        <div :for={item <- @item} class="flex gap-4 py-4 sm:gap-8">
          <dt class="w-1/4 flex-none text-[0.8125rem] leading-6 text-slate-500">
            <%= item.title %>
          </dt>
          <dd class="text-sm leading-6 text-slate-700"><%= render_slot(item) %></dd>
        </div>
      </dl>
    </div>
    """
